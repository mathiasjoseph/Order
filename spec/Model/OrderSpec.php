...
use Miky\Component\Order\Model\AdjustableInterface;
...
final class OrderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Miky\Component\Order\Model\Order');
    }

    function it_implements_Miky_order_interface()
    {
        $this->shouldImplement(OrderInterface::class);
    }

    function it_implements_Miky_adjustable_interface()
    {
