...
namespace spec\Miky\Component\Order\Modifier;
...
use Miky\Component\Order\Modifier\OrderItemQuantityModifierInterface;
...
final class OrderItemQuantityModifierSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Miky\Component\Order\Modifier\OrderItemQuantityModifier');
    }
